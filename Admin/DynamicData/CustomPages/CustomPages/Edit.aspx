<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" ValidateRequest="false" CodeFile="Edit.aspx.cs" Inherits="Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<h2 class="DDSubHeader">Edit entry from table <%= table.DisplayName %></h2>
		...
		<!-- TinyMCE -->
<script type="text/javascript" src="<%: ResolveClientUrl("~/Scripts/") %>tiny_mce/tiny_mce.js"></script>
