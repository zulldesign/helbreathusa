...
<div class="formRow clearfix">
    ...
    <div class="formInput"><asp:TextBox ID="CardNameTextBox" runat="server"></asp:TextBox></div>
    <div class="formError"><asp:RequiredFieldValidator ID="CardNameRequiredFieldValidator" 
    ControlToValidate="CardNameTextBox" runat="server" 
    ErrorMessage="Name on Card is Required" SetFocusOnError="True">*</asp:RequiredFieldValidator></div>
</div>

<div class="formRow clearfix">
    <label>Card Type:</label>
    <div class="formInput"><asp:DropDownList ID="CardTypeDropDownList" runat="server">
    ...
    <div class="formError"><asp:RequiredFieldValidator ID="RequiredFieldValidator1" 
            ControlToValidate="CardTypeDropDownList" runat="server" 
            ErrorMessage="Card Type is Required" SetFocusOnError="True">*</asp:RequiredFieldValidator></div>
</div>

<div class="formRow clearfix">
    <label>Card Number:</label>
    <div class="formInput"><asp:TextBox ID="CardNumberTextBox" runat="server"></asp:TextBox></div>
    <div class="formError"><asp:RequiredFieldValidator ID="CardNumberRequiredFieldValidator" 
            ControlToValidate="CardNumberTextBox" runat="server" 
            ErrorMessage="Card Number is Required" Display="Dynamic" 
            SetFocusOnError="True">*</asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="CardNumberRegularExpressionValidator" 
 ...
 <div class="formRow clearfix">
    ...
    <div class="formExp"> <asp:DropDownList ID="MonthDropDownList" runat="server">
            <asp:ListItem Text="Select..." Value=""></asp:ListItem>
    ...
    <div class="formError"><asp:RequiredFieldValidator ID="MonthRequiredFieldValidator" 
        ...
        <asp:CustomValidator ID="YearMonthCustomValidator" runat="server" 
            ...
            ControlToValidate="YearDropDownList" onservervalidate="YearMonthCustomValidator_ServerValidate">*</asp:CustomValidator></div>
</div>

<div class="formRow clearfix">
    <label>CVV:</label>
    <div class="cvv"><asp:TextBox ID="CVVTextBox" MaxLength="3" Columns="3" runat="server"></asp:TextBox></div>
    <div class="formError"><asp:RequiredFieldValidator ID="CVVRequiredFieldValidator" 
        ...
        <asp:RegularExpressionValidator ID="CVVRegularExpressionValidator" 
            ...
            ErrorMessage="CVV Not Valid" ValidationExpression="\d{3}|\d{2}">*</asp:RegularExpressionValidator></div>
</div>
